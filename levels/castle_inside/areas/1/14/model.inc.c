...
static const Gfx inside_castle_sm64ap_wall_sign_material_begin[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBA, G_CC_MODULATERGBA),
    gsSPClearGeometryMode(G_SHADING_SMOOTH),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
static const Gfx inside_castle_sm64ap_wall_sign_material_end[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
...
const Gfx inside_castle_sm64ap_wall_sign_dialog_070[] = {
    gsSPDisplayList(inside_castle_sm64ap_wall_sign_material_begin),
    gsSP2Triangles(0, 1, 2, 0x0, 0, 2, 3, 0x0),
    gsSPDisplayList(inside_castle_sm64ap_wall_sign_material_end),
    gsSPEndDisplayList(),
};

const Gfx inside_castle_sm64ap_wall_sign_dialog_046[] = {
    gsSPDisplayList(inside_castle_sm64ap_wall_sign_material_begin),
    gsSP2Triangles(4, 5, 6, 0x0, 4, 7, 5, 0x0),
    gsSPDisplayList(inside_castle_sm64ap_wall_sign_material_end),
    gsSPEndDisplayList(),
