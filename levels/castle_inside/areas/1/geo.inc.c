...
const GeoLayout castle_geo_000FA8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(0, geo_sm64ap_castle_wall_sign),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_000FD0[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(1, geo_sm64ap_castle_wall_sign),
...
const GeoLayout castle_geo_001000[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(2, geo_sm64ap_castle_wall_sign),
      GEO_ASM(  0, geo_painting_update),
...
const GeoLayout castle_geo_001038[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(3, geo_sm64ap_castle_wall_sign),
      GEO_ASM(  0, geo_painting_update),
...
const GeoLayout castle_geo_001088[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(4, geo_sm64ap_castle_wall_sign),
