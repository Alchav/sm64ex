...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_SPENT_COIN,              spent_coin_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SPENT_BLUE_COIN,         spent_blue_coin_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_AP_TRIGGER_SPARKLES_ANIMATION, ap_trigger_sparkles_animation_geo),
