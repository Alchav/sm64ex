...
const GeoLayout exclamation_box_geo[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_SWITCH_CASE(8, geo_switch_exclamation_box_state),
         GEO_OPEN_NODE(),
            ...
            GEO_DISPLAY_LIST(LAYER_OPAQUE, exclamation_box_collected_wing_cap_dl),
            GEO_DISPLAY_LIST(LAYER_OPAQUE, exclamation_box_collected_metal_cap_dl),
            GEO_DISPLAY_LIST(LAYER_OPAQUE, exclamation_box_collected_vanish_cap_dl),
            GEO_DISPLAY_LIST(LAYER_OPAQUE, exclamation_box_collected_generic_dl),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
