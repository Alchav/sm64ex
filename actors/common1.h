...
extern const GeoLayout spent_coin_geo[];
extern const GeoLayout spent_blue_coin_geo[];
...
extern const Gfx spent_coin_dl_front[];
extern const Gfx spent_coin_dl_tilt_right[];
extern const Gfx spent_coin_dl_side[];
extern const Gfx spent_coin_dl_tilt_left[];
extern const Gfx spent_blue_coin_dl_front[];
extern const Gfx spent_blue_coin_dl_tilt_right[];
extern const Gfx spent_blue_coin_dl_side[];
extern const Gfx spent_blue_coin_dl_tilt_left[];
