...
#define SURFACE_IS_LETHAL_QUICKSAND(cmd) \
    (cmd == SURFACE_DEEP_QUICKSAND || cmd == SURFACE_INSTANT_QUICKSAND \
     || cmd == SURFACE_DEEP_MOVING_QUICKSAND || cmd == SURFACE_INSTANT_MOVING_QUICKSAND)
