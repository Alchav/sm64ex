...
extern const BehaviorScript bhvHmcEntranceGate[];
...
extern const BehaviorScript bhvStarReplacementDoor[];
...
extern const BehaviorScript bhvAPTriggerSparkle[];
extern const BehaviorScript bhvAPTriggerSparkleSpawn[];
